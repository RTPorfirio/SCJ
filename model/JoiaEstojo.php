...
class JoiaEstojo {
    ...
    public static function EstojolistaJoias() {
        return JoiaEstojoDao::EstojolistaJoias();
    }

    public static function EstojolistaJoia($joia) {
        return JoiaEstojoDao::EstojolistaJoia($joia);
    }

    public static function EstojolistaJoiaQR($joia,$teste) {
        return JoiaEstojoDao::EstojolistaJoiaQR($joia,$teste);
    }

    public static function EstojoinsereJoia($joia) {
        return JoiaEstojoDao::EstojoinsereJoia($joia);
    }

    public static function EstojoEditaJoia($joia) {
        return JoiaEstojoDao::EstojoEditaJoia($joia);
    }

      public static function EstojoEditaValida($joia) {
        return JoiaEstojoDao::EstojoEditaValida($joia);
    }
    
    public static function EstojodeletaJoia($joia) {
        return JoiaEstojoDao::EstojodeletaJoia($joia);
    }

    public static function EstojoSelecionaUltimoId() {
        return JoiaEstojoDao::EstojoSelecionaUltimoId();
    }
}
